/*
/*
Veeva MyInsights Library version 182.0.153
...
(function (Q) {
    ...
    window.OnlineAPI = function () {
        ...
        function delegateOnlineRequest(queryConfig, deferredId, deferred) {
        ...
        function query(request) {
            ...
            window[uniqueCallbackName] = function (resp) {
                ...
                if ((typeof result === 'object' && result && result.success) || result === null) {
                    ...
                    deferred.reject('Query failed: ' + errorMessage + ' ' + JSON.stringify(request));
                }
            };
