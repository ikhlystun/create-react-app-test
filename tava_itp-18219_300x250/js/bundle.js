...
module.exports = function () {
  if ($('.tavalisseHome').length) {
    $('.tavalisseHome').on('click', function (e) {
      e.preventDefault();
      e.stopPropagation();
      Enabler.exit('Tavalisse Home');
    });
  }if ($('.moa').length) {
    $('.moa').on('click', function (e) {
      e.preventDefault();
      e.stopPropagation();
      Enabler.exit('MOA');
    });
...
module.exports = function (IScroll, id) {
	...
	this.startScrollFromBeginning = function () {
		if (!this.mouseOverIsi) {
			this.isiScroll.scrollTo(0, this.isiScroll.maxScrollY, this.isiScroll.maxScrollY * this.scrollSpeedMultiplier, IScroll.utils.ease.quadratic);
		}
	};
...
module.exports = function () {
	...
	var animationLoader = function () {
		...
		function animationInit() {
			$('.screen-1').fadeIn(animationSpeed).delay(2000).fadeOut(animationSpeed, function () {
				$('.screen-2, .animated-background').fadeIn(animationSpeed);
				setTimeout(function () {
					$('.screen-2').fadeOut(3000);
					$('.screen-3').fadeIn(animationSpeed).delay(3000).fadeOut(1000, function () {
						$('.screen-4').fadeIn(animationSpeed).delay(3000).fadeOut(1000, function () {
							isi.init();
							setTimeout(function () {
								$('.animated-background').fadeOut(animationSpeed, function () {
									$('.screen-5').fadeIn(animationSpeed).delay(2000).fadeOut(animationSpeed, function () {
										animationInit();
									});
								});
							}, timeout);
...
},{"./components/isi.js":2,"./vendor/iscroll-probe.js":6}],4:[function(require,module,exports){
"use strict";
...
},{"../components/exit-links.js":1,"../main.js":3}],6:[function(require,module,exports){
'use strict';
